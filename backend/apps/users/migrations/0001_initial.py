# Generated by Django 5.2.13 on 2026-05-04 18:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Public handle. 3-30 chars: letters, digits, underscores.', max_length=30, unique=True, validators=[django.core.validators.RegexValidator(message='Username must be 3-30 characters: letters, digits, underscores.', regex='^[a-zA-Z0-9_]{3,30}$')], verbose_name='username')),
                ...
                ('timezone', models.CharField(default='Asia/Kolkata', max_length=64, verbose_name='timezone')),
